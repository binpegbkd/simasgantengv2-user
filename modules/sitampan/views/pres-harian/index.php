            ...
            'update-jadwal' => function ($url, $model) use ($thn, $bln){
                if($model['kode_jadwal'] == 3){
                    return Html::button('<span class="fas fa-clock"></span>',[
                        ...
                        'title' => 'Update', 'class' => 'showModalButton btn-sm btn-warning',
                    ]);
                }else{
                    return Html::button('<span class="fas fa-clock"></span>',['value' => Url::to(['update-jadwal', 'id' => $model['nip'], 'bulan' => $bln, 'tahun' => $thn]), 
