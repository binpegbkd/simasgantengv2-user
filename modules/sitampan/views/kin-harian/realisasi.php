...
$this->title = 'Realisasi Kinerja Harian';
...
<div class="kin-harian-index">
    ...
    <div class="row ml-auto mr-auto">
        <?= $this->render('_search_rel', ['model' => $searchModel]); ?>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{update-rel}',
                'buttons' => [
                    'update-rel' => function ($url, $model) use ($bulan, $nexbul, $tahun) {
                        if($model['ok_kuan_h'] == 0 && $model['ok_waktu_h'] == 0){
                            if($model['real_kuan_h'] == 0 && $model['real_waktu_h'] == 0){
                                $x =  Html::button('<span class="fas fa-check-circle"></span>',['value' => Url::to($url), 
                                'title' => 'Entri/ Edit Realisasi', 'class' => 'showModalButton btn btn-link',
                                'style' => 'color : #28a745',
                                ]);
                            }else{
                                $x = ' '.Html::a('<span class="fas fa-times-circle"></span>',['hapus-rel', 'id' => $model['id']],
                                [ 
                        ...
                        }else $x = '<font size="-1">Sudah dinilai</font>';
                        return $x;
                    },
                ],
            ],
