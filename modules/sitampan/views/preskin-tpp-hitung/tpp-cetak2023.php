...
<table cellspacing="0" cellpadding="5" border="1" width="100%" style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
  <thead>
    <tr align="center">
      ...
      <td width="15%" rowspan="2">GOLONGAN</td>
      <td width="10%" rowspan="2">JUMLAH PNS</td>
      <td width="10%" rowspan="2">PAGU TPP</td>
      <td width="10%" rowspan="2">BEBAN KERJA 70%
        <hr size="1px" color="#000000">
        PRESTASI KERJA 30%</td>
      <td colspan="3">PRESTASI KERJA 30%</td>
      <td width="7%" rowspan="2">CUTI<br>HUKDIS</td>
      <td width="8%" rowspan="2">TPP PEGAWAI<br>
        BPJS 4%<br>
        JUMLAH KOTOR</td>
      <td width="8%" rowspan="2">BPJS 4%<br>
        BPJS 1%<br>
        PPH<br>
        JUMLAH POT<br>
        JUMLAH NET</td>
      <td width="10%" rowspan="2">TPP<br>
        DITERIMA</td>
    </tr>
    <tr align="center">
      <td width="7%">PRODUKTIVITAS<br>
        KERJA 60%</td>
      <td width="7%">DISIPLIN<br>
        KERJA 40%</td>
      <td width="7%">SAKIP<br>RB</td>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="right" valign="top">
        <?= Angka::Ribuan($rk['jml_sakip_rp']) ?><br><?= Angka::Ribuan($rk['jml_rb_rp']) ?></td>
      <td align="right" valign="top">
        <?= Angka::Ribuan($rk['jml_cuti_rp'])."<br>".Angka::Ribuan($rk['jml_hukdis_rp']) ?>
      </td>
      <td align="right" valign="top">
    ...
    <tr>
      ...
      <td align="right" valign="top"><?= Angka::Ribuan($tsak)."<br>".Angka::Ribuan($trb) ?></td>
      <td align="right" valign="top"><?= Angka::Ribuan($tcuti)."<br>".Angka::Ribuan($thukdis) ?></td>
      <td align="right" valign="top">
...
<table cellspacing="0" cellpadding="5" border="1" width="100%" style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
  <thead>
    <tr align="center">
      ...
      <td width="7%" rowspan="2">PAGU TPP</td>
      <td width="8%" rowspan="2">BEBAN KERJA 70%
        <hr size="1px" color="#000000">
        PRESTASI KERJA 30%</td>
      <td colspan="3">PRESTASI KERJA 30%</td>
      <td width="5%" rowspan="2">CUTI<br>HUKDIS</td>
      <td width="8%" rowspan="2">TPP PEGAWAI<br>
        BPJS 4%<br>
        JUMLAH KOTOR</td>
      <td width="10%" rowspan="2">BPJS 4%<br>
        BPJS 1%<br>
        PPH<br>
        JUMLAH POT<br>
        JUMLAH NET</td>
      <td width="10%" rowspan="2">TPP DITERIMA<br>
        TANDA TANGAN</td>
    </tr>
    <tr align="center">
      <td width="10%">PRODUKTIVITAS KERJA<br>
        (60%)</td>
      <td width="10%">DISIPLIN KERJA<br>
        (40%)</td>
      <td width="7%">SAKIP<br>RB</td>
    </tr>
  </thead>
  <tbody>
      ...
      foreach($dt['detail'] as $dtl){
        ...
        if($dtl['dj_asn'] != 0){
          ...
          foreach($dtl['rinci'] as $rin){
            ...
            $kin_pagu = round(($prestasi - $pres_pagu) * 0.8,0);
	?>
    <tr>
      ...
      <td align="right" valign="top">
        <?= $rin['kinerja'] ?>% X <?= Angka::Ribuan($kin_pagu) ?><br>
        = <?= Angka::Ribuan($rin['kinerja_rp']) ?>
      </td>
      <td align="right" valign="top">
        <?= $rin['presensi'] ?>% X <?= Angka::Ribuan($pres_pagu) ?><br>
        = <?= Angka::Ribuan($rin['presensi_rp']) ?>
      </td>
      <td align="right" valign="top">
        <?= Angka::Ribuan($rin['sakip_rp']) ?><br>
        <?= Angka::Ribuan($rin['rb_rp']) ?>
      </td>
      <td align="right" valign="top">
        <?= Angka::Ribuan($rin['cuti_rp']) ?><br>
    ...
    <tr>
      ...
      <td align="right" valign="top">
        <?= Angka::Ribuan($dtl['dj_sakip']) ?><br>
        <?= Angka::Ribuan($dtl['dj_rb']) ?>
      </td>
      <td align="right" valign="top">
        <?= Angka::Ribuan($dtl['dj_cuti']) ?><br>
      ...
      <tr>
        ...
        <td align="right" valign="top">
          <?= Angka::Ribuan($tdj_kinerja) ?>
        </td>
        <td align="right" valign="top">
          <?= Angka::Ribuan($tdj_presensi) ?>
        </td>
        <td align="right" valign="top">
          <?= Angka::Ribuan($tdj_sakip) ?><br><?= Angka::Ribuan($tdj_rb) ?>
        </td>
        <td align="right" valign="top">
          <?= Angka::Ribuan($tdj_cuti) ?><br><?= Angka::Ribuan($tdj_hukdis) ?>
        </td>
        <td align="right" valign="top">
