...
namespace app\modules\gen\generators\crud;
...
class Generator extends \app\modules\gen\Generator
{
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->type === 'text') {
            return "\$form->field(\$model, '$attribute')->textarea(['rows' => 2])";
        }
        ...
        if ($column->type === 'integer') {
            return "\$form->field(\$model, '$attribute')->widget(NumberControl::classname(), [
                'options' => \$saveOptions,
