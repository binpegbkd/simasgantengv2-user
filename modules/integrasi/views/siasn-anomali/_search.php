...
<div class="siasn-anomali-search">
    ...
    <?php // echo $form->field($model, 'nama')->textInput(['id' => 'tnama']) ?>
    <?php // echo $form->field($model, 'unorNama')->textInput(['id' => 'tunor']) ?>
    <?php // echo $form->field($model, 'unorIndukNama')->textInput(['id' => 'tinduk']) ?>
